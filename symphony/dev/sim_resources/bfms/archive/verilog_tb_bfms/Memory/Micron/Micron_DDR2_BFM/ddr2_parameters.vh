...
//<> ------------------ <<JETSON PROJECT>>
//<>  - user defines for current project requirements (easier to add here than to modify VIP scripts)
`define x16
`define sg25E
`define MAX_MEM
...
`endif `endif
    ...
    // parameter MEM_BITS         =      19; // Number of write data bursts can be stored in memory.  The default is 2^10=1024.
