//<> added to support VIP scripting which does not allow (at this time) unique compile toggles per file 
`define den1024Mb
`define MAX_MEM
`define mem_init
`define sg15E
...
`ifdef den1024Mb
    `include "../tb/bfms/Micron_DDR3_BFM/1024Mb_ddr3_parameters.vh"
`elsif den2048Mb
    `include "../tb/bfms/Micron_DDR3_BFM/2048Mb_ddr3_parameters.vh"
`elsif den4096Mb
    `include "../tb/bfms/Micron_DDR3_BFM/4096Mb_ddr3_parameters.vh"
`else
