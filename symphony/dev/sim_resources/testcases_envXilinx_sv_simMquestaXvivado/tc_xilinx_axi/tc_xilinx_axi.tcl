...
# ##########################################################################################
set TCFILENAME tc_xilinx_axi
set TCSUBDIR $TESTCASESDIR_XILINX/tc_xilinx_axi
...
lappend ::EXTRA_LIBS xilinx_vip axi_vip_v1_1_3
if {[string equal $::DEFAULT_SIMULATOR xsim]} {
    lappend ::EXTRA_LIBS axi_protocol_checker_v2_0_3 smartconnect_v1_0
}
