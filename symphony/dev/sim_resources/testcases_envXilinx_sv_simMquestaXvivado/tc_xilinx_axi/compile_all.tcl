...
# VIP BFM
simu_vlog -sv -incr -timescale $TCTIMESCALE "$SIMDIR/./bfms/xilinx_axi_vip/axi_master/sim/axi_master.sv" -L xilinx_vip -L axi_vip_v1_1_3
simu_vlog -sv -incr -timescale $TCTIMESCALE "$SIMDIR/./bfms/xilinx_axi_vip/axi_master/sim/axi_master_pkg.sv" -L xilinx_vip
