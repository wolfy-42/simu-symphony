...
# ##########################################################################################
set TCFILENAME tc_fidus_i2c_slave_uvm_agent 
set TCSUBDIR $TESTCASESDIR/$TCFILENAME
#setting the uvm directory in an environment variable,it is used in the uvm_filelist.txt to point to the files. 
#setting other used variables here too.
if {$::CMD_ARG_UVM > 0} {
  puts "\nSetting UVM directory in env variable TCUVMDIR.\n"
  set ::env(TCUVMDIR) $TESTCASESDIR/$TCFILENAME/uvm
}
...
#append ::SIMULATOR_INVOCATION " -modelsimini $TCSUBDIR/modelsim.ini"
