...
simu_vlog -sv -timescale $TCTIMESCALE "$SIMDIR/./bfms/fidus_axis_video_bfms/fidus_axis_video_frame_bfm_pkg.sv"
simu_vlog -sv -timescale $TCTIMESCALE "$SIMDIR/./bfms/fidus_axis_video_bfms/fidus_axis_video_interfaces.sv"
simu_vlog -sv -timescale $TCTIMESCALE "$SIMDIR/./bfms/fidus_axis_video_bfms/fidus_axis_video_source_bfm.sv"
simu_vlog -sv -timescale $TCTIMESCALE "$SIMDIR/./bfms/fidus_axis_video_bfms/fidus_axis_video_sink_bfm.sv"
