...
puts_debug1 "==============config_settings_vsim.tcl================\n"
...
# Outputs: none.
proc text_logs_init {} {
    puts_debug2 "==============config_settings_vsim::text_logs_init================\n"
...
proc ensure_fresh_lib {dir_name lib_name} {
    puts_debug2 "==============config_settings_vsim::ensure_fresh_lib================\n"
...
# Outputs: none.
proc map_precompiled_lib_list {} {
    puts_debug2 "==============config_settings_vsim::map_precompiled_lib_list================\n"
...
proc transcript_reset {name} {
    puts_debug2 "==============config_settings_vsim::transcript_reset================\n"
...
proc suxil {args} {
    puts_debug2 "==============config_settings_vlog::suxil $args TODO:fix =================\n"
...
set VSVLOG_OPTS "$REDIRECTSTD vlog -incr "
...
proc preSimCommand {} {
    puts_debug2 "==============config_settings_vsim::preSimCommand================\n"
...
proc optimizeCommand {tcSubDir tcFileName tcTimeScale} {
    puts_debug2 "==============config_settings_vsim::optimizeCommand================\n"
...
set VSSIM_OPTS "$REDIRECTSTD vsim  -permit_unmatched_virtual_intf "
# Log and WLF to result_rtl
# TDO: fix upper/lower var issue
...
proc simCommand {} {
    puts_debug2 "==============config_settings_vsim::simCommand================\n"
...
proc view_wave_log {view_wave wave_do tcSubDir tcFileName} {
    puts_debug2 "==============config_settings_vsim::view_wave_log================\n"
    global REGRESSION
...
set COVERAGE_REPORT_INVOCATION "coverage report -output $CURRENT_TCSUBDIR/result_rtl/$CURRENT_TCFILENAME.coverage_report.rep"
...
proc coverageMergeCmd {outFile inFile1 inFile2} {
    puts_debug2 "==============config_settings_vsim::coverageMergeCmd================\n"
    vcover merge -out $outFile $inFile1 $inFile2
    return
}
proc coverageReportCmd {outReport inCov} {
    puts_debug2 "==============config_settings_vsim::coverageReportCmd================\n"
