...
if {$::CMD_ARG_UVM > 0} {
  set TC_COMP_INVOCATION {simu_vlog -sv -incr -d UVM_TESTBENCH -timescale $TCTIMESCALE $TCSUBDIR/$TCFILENAME.sv }
} else {
...
proc optimizeCommand {tcSubDir tcFileName tcTimeScale} {
    puts stdout "==============config_settings_vsim::optimizeCommand================\n"
...
proc simCommand {tcSubDir tcFileName tcTimeScale} {
    puts stdout "==============config_settings_vsim::simCommand================\n"
