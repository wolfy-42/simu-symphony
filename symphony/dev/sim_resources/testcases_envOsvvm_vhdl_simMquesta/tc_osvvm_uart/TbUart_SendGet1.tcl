...
# --------------------------------------------------------------------//
# --------------------------------------------------------------------//
# Description   : Template testcase for uart osvvm in vhdl.
#
#               Command Line Options: uses modified scripts_lib/auto_gen/cmd_line_options.tcl
#
#               test-case: TbUart_SendGet1
...
# ##########################################################################################
set TCFILENAME TbUart_SendGet1
set TCSUBDIR $TESTCASESDIR_OSVVM/tc_osvvm_uart
