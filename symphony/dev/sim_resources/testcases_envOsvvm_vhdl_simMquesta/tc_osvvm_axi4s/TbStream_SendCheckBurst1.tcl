...
# --------------------------------------------------------------------//
# --------------------------------------------------------------------//
# Description   : Template testcase for axi4 stream osvvm in vhdl.
#
#               Command Line Options: uses modified scripts_lib/auto_gen/cmd_line_options.tcl
#
#               test-case: TbStream_SendCheckBurst1
...
# ##########################################################################################
set TCFILENAME TbStream_SendCheckBurst1
set TCSUBDIR $TESTCASESDIR_OSVVM/tc_osvvm_axi4s
