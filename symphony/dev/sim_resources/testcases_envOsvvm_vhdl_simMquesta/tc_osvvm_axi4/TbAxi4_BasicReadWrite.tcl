...
# --------------------------------------------------------------------//
# --------------------------------------------------------------------//
# Description   : Template testcase for axi4 osvvm in vhdl.
#
#               Command Line Options: uses modified scripts_lib/auto_gen/cmd_line_options.tcl
#
#               test-case: TbAxi4_BasicReadWrite
...
# ##########################################################################################
set TCFILENAME TbAxi4_BasicReadWrite
set TCSUBDIR $TESTCASESDIR_OSVVM/tc_osvvm_axi4
