...
# VIP BFM
vlog -sv -incr -timescale $TCTIMESCALE "$SIMDIR/./bfms/xilinx_axi_vip/axistream_master/sim/axistream_master.sv" -L xilinx_vip -L axi4stream_vip_v1_1_3
vlog -sv -incr -timescale $TCTIMESCALE "$SIMDIR/./bfms/xilinx_axi_vip/axistream_master/sim/axistream_master_pkg.sv" -L xilinx_vip
