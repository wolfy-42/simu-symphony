...
# ##########################################################################################
set TCFILENAME tc_xilinx_axis
set TCSUBDIR $TESTCASESDIR_XILINX/tc_xilinx_axis
...
if {[string equal $::DEFAULT_SIMULATOR vsim]} {
    ...
    append ::XELAB_INVOCATION " -initfile=xsim_ip.ini -L xilinx_vip -L axi4stream_vip_v1_1_3 -L axis_protocol_checker_v1_2_3 -L smartconnect_v1_0"
}
