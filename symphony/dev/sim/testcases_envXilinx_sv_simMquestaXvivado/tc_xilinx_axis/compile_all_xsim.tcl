...
# VIP BFM
exec >&@stdout xvlog -sv -incr "$SIMDIR/bfms/xilinx_axi_vip/axistream_master/sim/axistream_master.sv"
...
exec >&@stdout xvlog -sv -incr "$SIMDIR/bfms/xilinx_axi_vip/axistream_master/sim/axistream_master_pkg.sv" -initfile=xsim_ip.ini -L xilinx_vip
