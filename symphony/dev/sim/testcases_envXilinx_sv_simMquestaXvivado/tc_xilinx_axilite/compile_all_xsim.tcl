...
exec >&@stdout xvlog -sv -incr "$SIMDIR/bfms/xilinx_axi_vip/axilite_master/sim/axilite_master.sv"
...
exec >&@stdout xvlog -sv -incr "$SIMDIR/bfms/xilinx_axi_vip/axilite_master/sim/axilite_master_pkg.sv" -initfile=xsim_ip.ini -L xilinx_vip
